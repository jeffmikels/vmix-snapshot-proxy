...
const vMixStorage = 'C:/Users/AV/Documents/vMixStorage/'
...
function status() {
	...
	print( 'Get a list of all inputs: http://barnabas:8098/' )
	print( 'Force regen one input (0 means program): http://barnabas:8098/regen/#' )
	print( 'Force regen all inputs: http://barnabas:8098/regen' )
	print( 'Get input snapshot: http://barnabas:8098/#.jpg' )
